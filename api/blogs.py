...
BLOGS = [
    {
        ...
        "content": """
    <blockquote><p>“The Cloud Resume Challenge isn't a tutorial or a how-to guide. It's a project spec, and not a very helpful one at that.”<p>
    ...
    <b>Fresh out of boot camp, I chose to continue my learning and knock out the AZ-900 certification first thing. One week of cramming later, and I was ready to talk all about geo-redundant storage, identity and access management, and ARM templates. My wife learned by radiation more about cloud computing than she ever wanted to know. It was grueling and sometimes snore-inducing, but I managed to nail the exam, so on to the fun stuff!</b>

    <h3>Front-end</h3>

    <img src=”img/App_diagram.png” height=”400” />
    ...
    <img src=”img/photoshoot.png” width=”600” />
    ...
    <img src=”img/portfolio_ARM.png” height=”400” />
